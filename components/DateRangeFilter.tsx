...
const DateRangeFilter: React.FC<DateRangeFilterProps> = ({ onDateChange }) => {
    ...
    return (
        <div className="flex items-center flex-wrap gap-2">
            <button onClick={() => handlePresetClick('all')} className={presetButtonClasses('all')}>Tutti</button>
            ...
            <button onClick={() => handlePresetClick('thisMonth')} className={presetButtonClasses('thisMonth')}>Questo Mese</button>
            <button onClick={() => handlePresetClick('lastMonth')} className={presetButtonClasses('lastMonth')}>Mese Scorso</button>
