...
const NotificationDetailModal: React.FC<NotificationDetailModalProps> = ({ isOpen, onClose, notification }) => {
    ...
    const formattedDate = new Date(notification.created_at).toLocaleString('it-IT', {
        day: '2-digit',
        month: 'long',
        year: 'numeric',
        hour: '2-digit',
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title={notification.title || 'Dettaglio Notifica'}>
